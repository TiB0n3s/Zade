---
name: compact
description: Compact or summarize a long coding conversation into a continuation handoff. Use when the user asks to compact, summarize context, or prepare a handoff after a long session.
---
