---
name: update-config
description: Modify Claude Code configuration by safely updating settings.json files, hooks, permissions, MCP servers, plugin config, key settings, and related config schemas.
---
